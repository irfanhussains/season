            ...
            $.post(form.attr('action'), form.serialize(), function(data){
                ...
                if(data.status == 'success'){
                    form.fadeOut('fast', function(){
                        $('.TTWForm-container').append('<p class="success-message">Your enquiry has been successfuly submitted to Dawars Leather Admin. We will get back to you as soon as possible.<br/> <a href="index.html">Back to Home Page</a></p>');
                    });
